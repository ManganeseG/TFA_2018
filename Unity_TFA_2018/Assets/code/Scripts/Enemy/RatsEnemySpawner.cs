...
public class RatsEnemySpawner : MonoBehaviour
{
    ...
    public RatsEnemy RefToSpawn;
    public GameObject RefToNextSpawner;
    private List<RatsEnemy> enemies = new List<RatsEnemy>();
    ...
    private static RatsEnemySpawner current;
    public static RatsEnemySpawner Current
    {
        get { return current; }
    }
    ...
    private void spawnNextEnemy()
    {
        ...
        RatsEnemy spawned = GameObject.Instantiate(RefToSpawn, position, Quaternion.identity);
        spawned.Spawner = this;
        enemies.Add(spawned);

    }

    public void Destroy(RatsEnemy deadEnemy)
    {
    ...
    {
        foreach (RatsEnemy enemy in enemies)
        {
            ...
            foreach (RatsEnemy otherEnemy in enemies)
            {
                if (otherEnemy == enemy)
                    continue;
